      ...
      <div class="overview-boxes">
        <div class="box">
          <div class="right-side">
            ...
            <div class="number">
                <a  style="text-decoration:none" type="button" href="student_max_feed.php">GO....</a>
            </div>
            <div class="indicator">
        ...
        <div class="box">
          <div class="right-side">
            <div class="box-topic"><b>Recommendations</b></div>
            <div class="number">
            <a  style="text-decoration:none" type="button" href="student_set.php">MORE....</a>
            </div>
            <div class="indicator">
              <i class='bx bx-up-arrow-alt'></i>
            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $s = "select student.std_id,F_name,L_name,Gender,Grade,DOJ,Batch,Department,email,count,happy,about_college,about_faculty,recommend,preference,suggestions from student inner join sfeed on student.std_id = sfeed.std_id where student.user = '$user'";
                        ...
                        if(mysqli_num_rows($s1)>0)
                        {
                            foreach($s1 as $ss)
                            {
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <form action="student_delete_connect.php" method="post">
                                          <div>
