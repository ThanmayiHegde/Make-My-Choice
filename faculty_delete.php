            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $user1 = $_SESSION['id1'];
                        $s = "delete from ffeed where emp_id = '$user1' and user = '$user'";
                        $s1 = mysqli_query($con,$s);

                        $s2 = "delete from faculty where emp_id = '$user1' and user = '$user'";
                        $s3 = mysqli_query($con,$s2);
                        
                        $s4 = "select f.emp_id,name,f.Gender,f.Qualification,f.Grade_Taught,f.DOJ,f.YOE,count,happy,about_college,about_curr,workload,remunerisation,recommend,preference,HOD,suggestions from faculty as f inner join ffeed on f.emp_id = ffeed.emp_id where f.user = '$user'";
