            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $s = "select faculty.emp_id,F_name,L_name,Qualification,Grade_Taught,YOE,email,count,happy,workload,suggestions,HOD from faculty inner join ffeed on faculty.emp_id = ffeed.emp_id where faculty.user = '$user' and ffeed.HOD = 'Good'";
