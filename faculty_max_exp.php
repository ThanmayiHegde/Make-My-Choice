            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $s = "select e.emp_id,e.F_Name,e.L_Name,e.DOJ,count,happy,about_college,about_curr,workload,remunerisation,recommend,preference,HOD,suggestions from ffeed inner join faculty_exp as e on ffeed.emp_id = e.emp_id where e.exp = 'YES' and ffeed.user = '$user'";
