            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $s = "select emp_id,F_Name,L_Name,Gender,Grade_Taught,Qualification,YOE,email from faculty where user = '$user' and emp_id IN ((select emp_id from ffeed ) INTERSECT (select emp_id from ffeed where remunerisation = 'No'))";
