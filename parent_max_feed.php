            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $s = "select parent.std_id,name,pfeed.stdname,Gender,Qualification,phone,age,counts,happy,about_college,about_faculty,rate,progress,suggestions from parent inner join pfeed on parent.std_id = pfeed.std_id and parent.user = '$user' and pfeed.counts = (select MAX(counts) from pfeed)";
