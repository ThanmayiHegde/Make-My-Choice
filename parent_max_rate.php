            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $s = "select parent.std_id,name,Qualification,phone,counts,happy,rate,suggestions from parent inner join pfeed on parent.std_id = pfeed.std_id where parent.user = '$user' and pfeed.rate > (select AVG(rate) from pfeed)";
