            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $s = "select F_Name,L_Name,std_id,stdname,Qualification,Gender,age from parent where user = '$user' and std_id NOT IN ((select std_id from pubfeed) INTERSECT (select std_id from parent))";
