            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id'];
                        $s = "select name,Employment,Gender,awareness,about_college,infrastructure,rate,recommend,like_us,suggestions,counts from public inner join pubfeed on public.F_Name = pubfeed.name where public.user = '$user' and pubfeed.counts = (select MAX(counts) from pubfeed)";
