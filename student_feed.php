...
<body>
	<h1 style="color:white;">STUDENT FEEDBACK FORM</style></h1>

	
	<form action="student_feed_join.php" method="post">
		...
		<div class="form-control">
			<label for="users">Student ID</label>
			<input name="users" type="text" placeholder="Enter your ID"/>
		</div>

		<div class="form-control">
			<label for="users1">Orgainsiation ID</label>
			<input name="users1" type="text" placeholder="Enter your answer"/>
		</div>
		...
		<div class="form-control">
			<label for="i3">What do you describe about faculty?</label>
			<input name="i3" type="text" placeholder="Enter your answer" />
		</div>
		<div class="form-control">
			<label for="i7">Who is your best faculty?</label>
			<input name="i7" type="text" placeholder="Enter your answer" />
		</div>

		<div class="form-control">
			<label for="i4">Would you recommend your others to join your college?<br>(Yes  / NO)</label>
			<input name="i4" type="text" placeholder="Enter your answer" />
		</div>

		<div class="form-control">
			<label for="i5">Subjects that you prefer and like</label>
