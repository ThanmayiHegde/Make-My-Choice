            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $s = "select std_id,F_Name,L_Name,Gender,Grade,Batch,Department,email from student where user = '$user' and std_id IN ((select std_id from sfeed ) INTERSECT (select std_id from sfeed where recommend = 'Yes'))";
