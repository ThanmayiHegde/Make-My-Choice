            ...
            <table class="tb" style="width:100%;">
                ...
                <tbody>
                    <?php
                        ...
                        $user = $_SESSION['id1'];
                        $sql = "CALL no_of_years('$user')";
                        $p2 = mysqli_query($con,$sql);
                            $s = "select student.std_id,F_name,L_name,Gender,Grade,DOJ,Batch,Department,email,No_Of_Years,count,happy,about_college,about_faculty,recommend,preference,suggestions from student inner join sfeed on student.std_id = sfeed.std_id where student.std_id = '$user'";
                            ...
                            if(mysqli_num_rows($s1)>0)
                            {
                                foreach($s1 as $ss)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center"><?= $ss['No_Of_Years']?></td>
